...
void forward(float dist, float speed) //supposed to be reverse
{
...
void left(float ang, float speed) //supposed to be left
{
  ...
  targetTicks = leftReverseTicksTurns + deltaTicks - 42;
...
void right(float ang, float speed) //supposed to be right
{
  ...
  targetTicks = rightReverseTicksTurns + deltaTicks - 70;
